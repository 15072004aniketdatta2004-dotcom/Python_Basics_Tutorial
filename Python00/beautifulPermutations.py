"""
Beautiful Permutations - CSES Problem.

Given N, produce a permutation of 1..N where every pair of adjacent
elements differs by more than 1.  Construction: evens first, then odds.
"""
...
def solve() -> None:
    """Read N from stdin and print a beautiful permutation (or NO SOLUTION)."""
